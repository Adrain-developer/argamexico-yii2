(function ($) {
    ...
    if($('.site-header li.dropdown ul').length){
        $('.site-header .navigation-box li.dropdown').append('<div class="dropdown-btn"><span class="fa fa-angle-right"></span></div>');
    }
    ...
    if($('.mobile-menu').length){
        ...
        var mobileMenuContent = $('.site-header .main-navigation').html();
