											...
											<section class=" history-one">
												<div class="container">
													<div id="cseguridad" class="block-title text-center">
														<p class="block-title__tag-line "><strong>SEGURIDAD LABORAL</strong>

														</p><!-- /.block-title__tag-line -->
														<h3 class="block-title__title "><span class="block-title__bold">ESTUDIOS PARA EVALUAR LAS CONDICIONES DE TRABAJO EN EL MEDIO AMBIENTE LABORAL
															</span>
															<!-- /.block-title__bold -->
