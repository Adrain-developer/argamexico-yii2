											...
											<section class=" inner-banner" style="background-image: url(<?= (Yii::$app->homeUrl . $rutas->pathImagenIdxCons) ?>);">
												<div class="container">
													...
													<ul class="list-unstyled thm-breadcrumb">
														...
														<li class="active"><a href="#"><strong>Protección al medio ambiente</strong></a></li>
													</ul><!-- /.thm-breadcrumb -->
												</div><!-- /.container -->
											</section>
										</div>
												...
												<div class="elementor-element elementor-element-6310236 elementor-widget elementor-widget-indext_sec_title1" data-id="6310236" data-element_type="widget" data-widget_type="indext_sec_title1.default">
													<div class="elementor-widget-container">
														<section class=" history-one">
															<div class="container">
																<div id="cseguridad" class="block-title text-center">
																	<p class="block-title__tag-line "><strong></strong>

																	</p><!-- /.block-title__tag-line -->
																	<h3 class="block-title__title "><span class="block-title__bold">Protección al medio ambiente
																		</span>
																		<!-- /.block-title__bold -->
