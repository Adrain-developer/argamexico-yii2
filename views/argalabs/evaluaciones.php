...
<div data-elementor-type="wp-page" data-elementor-id="23" class="elementor elementor-23" data-elementor-settings="[]">
									...
									<div class="elementor-element elementor-element-f2fe049 elementor-widget elementor-widget-indext_page_banner" data-id="f2fe049" data-element_type="widget" data-widget_type="indext_page_banner.default">
										<div class="elementor-widget-container">
											<section class=" inner-banner" style="background-image: url(../web/images/bannerlabs.jpg);">
												<div class="container">
													<h2 class="inner-banner__title">FUENTES FIJAS Y EMISIONES A LA ATMÓSFERA
            ...
            <div class="service-two__upper">
                <div class="container">
                    <div class="block-title text-center">
                        <p class="block-title__tag-line">EVALUACIONES</p><!-- /.block-title__tag-line -->
                        <h3 class="block-title__title block-title__white">EN EMPRESAS QUE EMITEN<br>
                            <span class="block-title__bold">CONTAMINANTES A LA ATMÓSFERA
</span>
                            <!-- /.block-title__bold -->
	...
	<div class="container">
		<h2 class="cta-three__title">HIGIENE LABORAL
</h2><!-- /.cta-three__title -->
		<p class="cta-three__text">EVALUACIÓN DE CONDICIONES Y CONTAMINANTES EN EL AMBIENTE LABORAL

</p>
		<!-- /.cta-three__text -->
		<a href="<?= Url::toRoute(['argalabs/higiene']);?>" class="cta-three__btn thm-btn">Ver las <strong>Normativas</strong></a><!-- /.thm-btn -->
	</div><!-- /.container -->
</section>
				</div>
				</div>
